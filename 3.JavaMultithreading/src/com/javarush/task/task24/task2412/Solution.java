    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            ...
            private int compareName(Stock stock1, Stock stock2) {
                String n1 = (String) stock1.get("name");
                String n2 = (String) stock2.get("name");
                return n1.compareTo(n2);
            }

            private int compareDate(Stock stock1, Stock stock2) {
                Long d1 = ((Date) stock1.get("date")).getTime() / (24 * 60 * 60 * 1000);
                Long d2 = ((Date) stock2.get("date")).getTime() / (24 * 60 * 60 * 1000);
