...
public class Cat implements Pet {
    ...
    public Sayable toSayable(final int i) {
        class CatPet implements Sayable {
            private StringBuilder countLitter = new StringBuilder();

            {
                countLitter.append(" говорит м");
                for (int j = 0; j < i; j++) {
                    countLitter.append("я");
                }
                countLitter.append("у!");
            }
            ...
            public String say() {
                if (i < 1) {
                    ...
                    return name + countLitter.toString();
                }
